...
class Run:
    ...
    def __init__(
        ...
        self.gear_selector.run_to_position(0, "clockwise", 100)
...
class MasterControlProgram:
    ...
    def __init__(self, brick: PrimeHub, debug_mode: bool, **defaults) -> None:
        """
        ...
        self.debug_mode = debug_mode
        defaults.update({"brick": brick, "debug_mode": debug_mode})
    ...
    def light_up_display(self, brick: PrimeHub, number: int, max_number: int):
        ...
        if display_as == "X":
            ...
            brick.light_matrix.set_pixel(1, 4, brightness=100)
            brick.light_matrix.set_pixel(2, 2, brightness=100)
            brick.light_matrix.set_pixel(3, 0, brightness=100)
            brick.light_matrix.set_pixel(3, 1, brightness=100)
            brick.light_matrix.set_pixel(3, 3, brightness=100)
            brick.light_matrix.set_pixel(3, 4, brightness=100)
        elif display_as == "C":
            brick.light_matrix.off()
            brick.light_matrix.set_pixel(1, 1, brightness=100)
            brick.light_matrix.set_pixel(1, 2, brightness=100)
            brick.light_matrix.set_pixel(1, 3, brightness=100)
            brick.light_matrix.set_pixel(2, 0, brightness=100)
            brick.light_matrix.set_pixel(2, 4, brightness=100)
            brick.light_matrix.set_pixel(3, 0, brightness=100)
            brick.light_matrix.set_pixel(3, 4, brightness=100)
        elif display_as == "T":
            brick.light_matrix.off()
            brick.light_matrix.set_pixel(1, 0, brightness=100)
            brick.light_matrix.set_pixel(2, 0, brightness=100)
            brick.light_matrix.set_pixel(2, 1, brightness=100)
            brick.light_matrix.set_pixel(2, 2, brightness=100)
            brick.light_matrix.set_pixel(2, 3, brightness=100)
            brick.light_matrix.set_pixel(2, 4, brightness=100)
            brick.light_matrix.set_pixel(3, 0, brightness=100)
        elif display_as == "R":
            brick.light_matrix.off()
            ...
            brick.light_matrix.set_pixel(2, 4, brightness=100)
            brick.light_matrix.set_pixel(3, 1, brightness=100)
            brick.light_matrix.set_pixel(3, 2, brightness=100)
            brick.light_matrix.set_pixel(3, 3, brightness=100)
