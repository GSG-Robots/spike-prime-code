...
def run():
    ...
    gyro_turn(0, 90, Pivot.RIGHT_WHEEL)
    gyro_turn(-35, 90, Pivot.LEFT_WHEEL)
    ...
    gyro_drive(-35, -70, cm(23), accelerate=5, decelerate=5)
    gyro_turn(-125, 90, Pivot.LEFT_WHEEL)
    gyro_drive(-125, -30, cm(13), accelerate=5, decelerate=25)
    run_attachment(Attachment.BACK_LEFT, 50, 1)
    gyro_drive(-125, 70, cm(2))
    gyro_turn(-20, 70, Pivot.RIGHT_WHEEL)
