...
def run():
    ...
    gyro_drive(-90, 800, cm(42), accelerate=10, decelerate=30)
    ...
    run_attachment(Attachment.FRONT_LEFT, 250, 200, stall=False, when_i_say_duration_i_mean_degrees=True)
    gyro_drive(0, 500, cm(3), accelerate=10, decelerate=30)
    run_attachment(Attachment.FRONT_LEFT, 300, 250, stall=True, when_i_say_duration_i_mean_degrees=True)
    gyro_drive(0, 700, cm(6), accelerate=10, decelerate=30)
    gyro_drive(0, 1000, sec(0.5), pid=PID(0, 0, 0))
    run_attachment(Attachment.FRONT_RIGHT, 1000, 6)
    ...
    gyro_turn(90)
    gyro_set_origin()
    gyro_drive(0, 1000, cm(27))
    gyro_turn(75, 120, pivot=Pivot.CENTER)
    gyro_drive(75, 1000, cm(79))
