...
def run():
    ...
    run_attachment(Attachment.FRONT_LEFT, 250, 250, stall=False, when_i_say_duration_i_mean_degrees=True)
    gyro_drive(0, 500, cm(3), accelerate=10, decelerate=30)
    run_attachment(Attachment.FRONT_LEFT, 350, 200, stall=True, when_i_say_duration_i_mean_degrees=True)
