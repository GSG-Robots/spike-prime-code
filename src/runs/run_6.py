...
def run():
    # Set Gyro Origin
    gyro_wall_align(0.3)
    run_attachment(Attachment.FRONT_LEFT, -200, 0.5)
    ...
    run_attachment(Attachment.FRONT_LEFT, 350, 260, stall=False, when_i_say_duration_i_mean_degrees=True)
    ...
    run_attachment(Attachment.FRONT_RIGHT, 1000, 8)
