...
from ..gsgr.conditions import cm, pickup, impact, wheels_blocked, OR
...
def run():
    ...
    gyro_drive(90, -700, cm(25), accelerate=10, decelerate=20)
    gyro_drive(90, 400, cm(13), accelerate=10, decelerate=40)
    gyro_drive(90, -400, cm(4), accelerate=10, decelerate=40, brake=False)
    gyro_turn(5, 100, Pivot.LEFT_WHEEL, timeout=2500, brake=False)
    gyro_drive(15, 1000, impact(cm(105)))
    #gyro_turn()
