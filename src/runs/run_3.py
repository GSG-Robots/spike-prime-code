...
def run():
    ...
    gyro_turn(90, pivot=Pivot.LEFT_WHEEL, timeout=2500)
    gyro_drive(90, -900, OR(wheels_blocked(), cm(83)), accelerate=10, decelerate=0)
    run_attachment(Attachment.BACK_RIGHT, -700, 1.2)
    gyro_drive(90, 800, cm(5), accelerate=40, decelerate=40)
    ...
    gyro_drive(90, 400, cm(8), accelerate=10, decelerate=40)
    # gyro_turn(45, 100, Pivot.RIGHT_WHEEL, timeout=2500)
