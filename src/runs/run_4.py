...
from ..gsgr.movement import gyro_drive, gyro_set_origin, gyro_turn, gyro_wall_align, run_attachment
...
def run():
    ...
    run_attachment(Attachment.BACK_LEFT, -700, 1, stall=True, untension=5)
