...
class Run:
    def __init__(
        ...
        if self.debug_mode:
            hw.brick.speaker.beep(60, 0.2)
            hw.brick.speaker.beep(80, 0.2)
            hw.brick.speaker.beep(60, 0.2)
            hw.brick.speaker.beep(80, 0.2)

        self.check_battery()
        hw.gear_selector.set_stall_detection(True)
        hw.gear_selector.set_stop_action("brake")
        hw.gear_selector.run_to_position(0, "clockwise", 100)
    ...
    def drive(
        ...
        speed: int,
        until: ConditionBase,
        correctors: list[Corrector] | Corrector = [],
    ):
    ...
    def gyro_drive(
        ...
        speed: int,
        degree: int,
        ending_condition: ConditionBase,
